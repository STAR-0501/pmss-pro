            ...
            for element in game.elements["rope"]:
                ...
                if element.type == "rope":
                    ...
                    if (hasattr(element, "start") and hasattr(element, "end")) and (
                        (hasattr(element.start, "type") and element.start == target)
                        or (hasattr(element.end, "type") and element.end == target)
                        or (
                            hasattr(element.start, "wall")
                            and element.start.wall == target
                        )
                        or (hasattr(element.end, "wall") and element.end.wall == target)
                    ):
